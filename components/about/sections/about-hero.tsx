...
export function AboutHero() {
  return (
    <section className="relative overflow-hidden" id="about-hero">
      ...
      <h1
        className="font-mokoto text-[6rem] sm:text-[12rem] md:text-[16rem] lg:text-[20rem] xl:text-[25rem] text-gray-500/15 absolute top-[20%] left-1/2 -translate-x-1/2 pointer-events-none select-none z-0"
        style={{
          lineHeight: 1,
          whiteSpace: "nowrap",
      ...
      <div className="container mx-auto px-4 sm:px-6 py-24 sm:py-32 md:py-40 lg:py-52 relative z-10 flex flex-col items-center text-center justify-center max-w-screen-xl md:max-w-3xl lg:max-w-7xl">
        <div className="space-y-6 sm:space-y-8 mt-10">
          <div>
            ...
            <h2 className="font-kapital text-4xl md:text-6xl lg:text-7xl xl:text-8xl leading-tight mb-4 sm:mb-6">
