...
export function BusinessesHero() {
  return (
    ...
    >
      ...
      <h1
        className="font-mokoto text-[8rem] sm:text-[12rem] md:text-[16rem] lg:text-[18rem] text-gray-500/15 absolute top-[15%] md:top-[20%] left-1/2 -translate-x-1/2 pointer-events-none select-none z-0"
        style={{
          lineHeight: 1,
          whiteSpace: "nowrap",
