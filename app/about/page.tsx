      ...
      <div className="bg-main relative min-h-[1500px] overflow-hidden rounded-t-4xl lg:rounded-t-[5rem]">
        ...
        <div className="absolute right-1/2 -bottom-20 translate-x-1/2 opacity-70">
          ...
          <div className="relative flex items-center justify-center">
            ...
            {/* Inner Core */}
            <div className="size-max-w-[18rem] absolute size-4 overflow-hidden rounded-full border border-white/20 bg-[#3A3848]/80 bg-linear-to-br from-gray-600 via-[#1D1F1F] via-20% to-[#1D1F1F]/70 shadow-[0_0_20px_rgba(0,0,0,0.3)] sm:size-56 md:size-64 lg:size-72" />
          </div>
        </div>
        <AboutOverview />
        <AboutMissionVision />
